...
public class RecipeApiClient {
    ...
    public String fetchRecipesByTitle(String query) throws Exception{
        String endpoint = ApiSearchByRecipe + "?query=" + query + "&number=100&apiKey=e46029883b574497bbdc4df0b9806361";
    ...
    public String fetchRecipesByCuisine(String cuisine) throws Exception{
        String endpoint = ApiSearchByRecipe + "?cuisine=" + cuisine + "&number=100&apiKey=e46029883b574497bbdc4df0b9806361";
        HttpURLConnection connection = (HttpURLConnection) new URL(endpoint).openConnection();
        connection.setRequestMethod("GET");
